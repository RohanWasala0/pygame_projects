...
from pygame import sprite, Vector2, event, draw, Color, Surface, KEYDOWN, K_SPACE, display, mask, Rect
...
class Ball(sprite.Sprite):
    def __init__(self, 
        ...
        self.radius = self.dimensions[0]//2
        self.speed = 600
    ...
    def draw_trail(self, screen):
        for i, position in enumerate(self.trail):
            ...
            draw.circle(screen, trail_color, position, max(1, int(self.radius * alpha * 0.5)))
